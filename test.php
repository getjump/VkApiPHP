...
require 'getjump/Vk/ApiResponse.php';
require 'getjump/Vk/Response.php';
require 'getjump/Vk/ErrorResponse.php';
...
//{
//    printf("<h1>%s</h1>", $i);
//    $js1 = $vk->request('messages.get', ['count' => 200, 'offset' =>$i*200])->toJs();
//    $js2 = $vk->request('messages.get', ['count' => 200, 'offset' =>($i+1)*200])->toJs();
//    $js3 = $vk->request('messages.get', ['count' => 200, 'offset' =>($i+2)*200])->toJs();
//    $js4 = $vk->request('messages.get', ['count' => 200, 'offset' =>($i+3)*200])->toJs();
//
//    var_dump($js1->append($js2)->append($js3)->append($js4)->execute());
////    $js1->append($js2)->append($js3)->append($js4)->execute()->response->each(function($i, $v) use(&$count)
////    {
////        $v->each(function($c, $d) use(&$count) {
////            if(preg_match('/паш/iu', $d->body)) $count++;
////            //print $d->body . '<br>';
////        });
////    });
//}
